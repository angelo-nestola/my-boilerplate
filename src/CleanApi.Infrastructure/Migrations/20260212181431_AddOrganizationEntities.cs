    ...
    public partial class AddOrganizationEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrgRoleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleCapabilities_OrgRoles_OrgRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrgAssignments_OrgRoles_OrgRoleId",
                        column: x => x.OrgRoleId,
                        principalTable: "OrgRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrgAssignments_OrgUnits_OrgUnitId",
                        column: x => x.OrgUnitId,
                        principalTable: "OrgUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrgAssignments_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrgAssignments_OrgRoleId",
                table: "OrgAssignments",
                column: "OrgRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_OrgAssignments_OrgUnitId",
                table: "OrgAssignments",
                column: "OrgUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_OrgAssignments_PersonId_OrgUnitId_OrgRoleId_ValidFrom",
                table: "OrgAssignments",
                columns: new[] { "PersonId", "OrgUnitId", "OrgRoleId", "ValidFrom" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrgRoles_Code",
                table: "OrgRoles",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleCapabilities_OrgRoleId_CapabilityId",
                table: "RoleCapabilities",
                columns: new[] { "OrgRoleId", "CapabilityId" },
                unique: true);
        }
